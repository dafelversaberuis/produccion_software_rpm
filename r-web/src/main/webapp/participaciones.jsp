...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearParticipacion.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">(Agregar nueva organización)</a><br><br>
...
<input	type="button" value=" REGRESAR A MUJERES " onclick="window.close()" />				
