...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearHecho.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=990, height=590'); return false;" style="text-decoration:none">(Ingresar nuevo hecho)</a><br><br>
