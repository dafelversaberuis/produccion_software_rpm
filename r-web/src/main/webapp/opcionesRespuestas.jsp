...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearOpcion.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=500'); return false;" style="text-decoration:none">Crear nueva opción de respuesta</a><br><br>
