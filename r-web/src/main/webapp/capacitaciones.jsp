...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearCapacitacion.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">(Nueva capacitación)</a><br><br>
