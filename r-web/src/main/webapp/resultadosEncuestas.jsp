...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr >
		...
		<td align="center" bgcolor="<%=color %>" ><a href="#" onclick="window.open('/r-web/estructura.jsp?encuesta=<%=i[0] %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=600, height=400'); return false;" style="text-decoration:none">Ver Diseño</a></td>
		<td align="center" bgcolor="<%=color %>" ><%if(!i[4].equals("No")){ %><a href="#" onclick="window.open('/r-web/resultado.jsp?encuesta=<%=i[0] %>', 'popup2', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=700, height=500'); return false;" style="text-decoration:none">Resultados</a><%} %></td>
		<td align="center" bgcolor="<%=color %>"><%if(i[4].equals("No")){ %><a href="#" onclick="cargarEliminarEncuesta(<%=i[0]%>); return false;">Eliminar</a><%} %></td> 
		
		<td align="center" bgcolor="<%=color %>"><%if(i[4].equals("No")){ %><a href="#" onclick="window.open('/r-web/editarEncuesta.jsp?id=<%=i[0]%>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Editar</a><%} %></td>
