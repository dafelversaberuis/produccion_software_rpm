...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearProyecto.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear nuevo proyecto</a><br><br>
