...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      <title>MUASOFT - RUTA PACÍFICA DE LAS MUJERES</title>
    <meta name="Description" content="MUASOFT - RUTA PACÍFICA DE LAS MUJERES">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Copias de seguridad sin conexión a internet</h4>
<br/>
<a href="#" onclick="crearBackupOffline(); return false;">(Crea una copia de seguridad para enviar a ruta pacífica Bogotá)</a>

<br>
Estos archivos se envían a Bogotá para cuando se trabja sin internet en esa sede se encuentre actualizado.
<br>
