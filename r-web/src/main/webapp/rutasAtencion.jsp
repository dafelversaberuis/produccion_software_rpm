			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Acceso a la justicia/implementación de las rutas de atención del caso: <%=nombreCurso %></h4>

<br/><br/>
<a href="#" onclick="window.open('/r-web/crearRuta.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=990, height=550'); return false;" style="text-decoration:none">(Ingresar nueva ruta de atención)</a><br><br>
...
<input	type="button" value=" REGRESAR A CASOS " onclick="window.close()" />
	    </center>
