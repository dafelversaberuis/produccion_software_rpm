...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr >
		...
		<td align="left" bgcolor="<%=color %>">
		<%if(i[2].equals("S")){ %><a href="#" onclick="window.open('/r-web/verLogo.jsp?id=<%=i[0]%>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Ver logo</a><%  }else{%> <a href="#" onclick="window.open('/r-web/subirLogo.jsp?id=<%=i[0]%>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Cargar nuevo logo</a><% } %>
		</td>
		<td align="left" bgcolor="<%=color %>">
