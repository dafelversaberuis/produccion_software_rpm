...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearEncuesta.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Crear una nueva encuesta</a><br><br>
