...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearMujer.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=970, height=600'); return false;" style="text-decoration:none">(Ingresar nueva mujer)</a><br><br>
