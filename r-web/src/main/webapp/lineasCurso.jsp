...
<br/><br/> 
<a href="#" onclick="window.open('/r-web/crearLineaC.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Adicionar línea estratégica al curso</a><br><br>
