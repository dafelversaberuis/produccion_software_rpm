...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearProyectoLinea.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear nueva relación proyecto-línea-financiador</a><br><br>
