...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr >
		...
		<td align="center" bgcolor="<%=color %>"><a href="#" onclick="window.open('/r-web/editarTema.jsp?id=<%=i[0]%>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Editar tema</a></td>		
	</tr>
	<%
		}
	%>
