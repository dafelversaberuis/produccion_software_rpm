...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearMC.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=yes, resizable=no, width=650, height=400'); return false;" style="text-decoration:none">Inscribir mujer en el curso</a><br><br>
