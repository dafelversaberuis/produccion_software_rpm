			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Acopañamiento psicosocial del caso: <%=nombreCurso %></h4>

<br/><br/>
<a href="#" onclick="window.open('/r-web/crearAcompanamiento.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=1024, height=750'); return false;" style="text-decoration:none">(Ingresar nuevo acompañamiento)</a><br><br>
