...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearPregunta.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=450'); return false;" style="text-decoration:none">Crear una nueva pregunta a la encuesta</a><br><br>
