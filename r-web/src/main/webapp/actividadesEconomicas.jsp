...
<br/><br/>
<a href="#" onclick="window.open('/r-web/crearActividad.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=400, height=250'); return false;" style="text-decoration:none">(Ingresar nueva ocupación)</a><br><br>
